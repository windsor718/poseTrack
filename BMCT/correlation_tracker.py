"""
Original Author: Mahmoud I.Zidan
Forked and edited by: Yuta Ishitsuka

Sample Appearance Model for the single camera tracking
"""
...
class CorrelationTracker:
    ...
    def update(self,bbox,img):
        ...
        if bbox != []:
            self.tracker.start_track(img, rectangle(long(bbox[0]),
                                long(bbox[1]), long(bbox[2]), long(bbox[3])))
